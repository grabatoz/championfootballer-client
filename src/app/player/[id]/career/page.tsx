...
//                     borderRadius:3,
//                     // White panel look like screenshot
//                     background:'#ffffff',
//                     overflow:'hidden',
//                     position:'relative',
...
//                 >
//                   {/* Title centered top */}
//                   <Box sx={{ textAlign:'center', pt:1.2, pb:0.4 }}>
//                     <Typography sx={{ fontSize:15, fontWeight:700, color:'#2d2d2d', letterSpacing:.4 }}>Performance Over Time</Typography>
//                   </Box>
//                   {/* Controls Row */}
//                   <Box
//                     sx={{
...
//                   {/* Side ribbons redesigned thinner to match mock */}
//                   <Box sx={{ position:'absolute', top:60, bottom:40, left:12, width:22, background:'#0496a5', color:'#fff', borderRadius:1.4, display:'flex', alignItems:'center', justifyContent:'center', writingMode:'vertical-rl', transform:'rotate(180deg)', fontSize:10, fontWeight:700, letterSpacing:.4, zIndex:3, boxShadow:'0 0 0 1px rgba(0,0,0,0.1)' }}>
//                     Average XP Points
//                   </Box>
//                   <Box sx={{ position:'absolute', top:60, bottom:40, right:12, width:26, background:'#0d6cb3', color:'#fff', borderRadius:1.4, display:'flex', alignItems:'center', justifyContent:'center', writingMode:'vertical-rl', transform:'rotate(180deg)', fontSize:10, fontWeight:700, letterSpacing:.4, zIndex:3, boxShadow:'0 0 0 1px rgba(0,0,0,0.1)' }}>
//                     Accumulative XP Points
//                   </Box>

//                   {/* Chart */}
//                   <Box sx={{ position:'relative', zIndex:4, flex:1, minHeight:0, px:8, pt:8, pb:2 }}>
//                     <ResponsiveContainer width="100%" height="100%">
//                       <ComposedChart
//                         data={chartData}
//                         margin={{ top: 10, left: 10, right: 10, bottom: 34 }}
//                       >
//                         <XAxis
//                           dataKey="label"
//                           stroke="#ccc"
//                           tick={{ fontSize:11, fill:'#222' }}
//                           interval={0}
//                           tickLine={{ stroke:'#ccc' }}
//                           axisLine={{ stroke:'#bbb' }}
//                         />
...
//                           }}
//                         />
//                         {/* Average points as bars */}
//                         <Bar
//                           yAxisId="avg"
//                           dataKey="avgPoints"
//                           name={`Avg Points / ${groupingType==='weekly'?'Week':'Month'}`}
//                           fill="url(#avgBarGradient)"
//                           maxBarSize={34}
//                           radius={[4,4,0,0]}
//                         />
//                         {/* Cumulative XP as line */}
//                         <Line
//                           yAxisId="cum"
//                           type="monotone"
...
//                           stroke="#0d6cb3"
//                           strokeWidth={3}
//                           dot={{ r:3, stroke:'#fff', strokeWidth:1.2, fill:'#0d6cb3' }}
//                           activeDot={{ r:6, stroke:'#0c3144', strokeWidth:1, fill:'#0d6cb3' }}
//                         />
//                         {/* Removed individual match scatter to match provided design image */}
//                         <defs>
...
//                             <stop offset="0%" stopColor="#18c17b" />
//                             <stop offset="100%" stopColor="#07995b" />
//                           </linearGradient>
//                         </defs>
//                       </ComposedChart>
//                     </ResponsiveContainer>
...
//                   {/* Legend */}
//                   <Box sx={{ position:'relative', zIndex:4, display:'flex', justifyContent:'center', flexWrap:'wrap', gap:4, pb:1.2, mt:.2, borderTop:'1px solid #e3e8ef', background:'#f7f9fb' }}>
//                     <Box sx={{ display:'flex', alignItems:'center', gap:.6 }}>
//                       <Box sx={{ width:16, height:12, borderRadius:2, background:'linear-gradient(180deg,#18c17b 0%,#07995b 100%)' }} />
//                       <Typography sx={{ fontSize:11, color:'#444', fontWeight:600 }}>Avg Points / {groupingType==='weekly'?'Week':'Month'}</Typography>
//                     </Box>
//                     <Box sx={{ display:'flex', alignItems:'center', gap:.6 }}>
//                       <Box sx={{ width:16, height:6, borderRadius:2, background:'#0d6cb3' }} />
//                       <Typography sx={{ fontSize:11, color:'#444', fontWeight:600 }}>Cumulative XP Points</Typography>
//                     </Box>
//                   </Box>
//                 </GlassCard>
//                 {/* Explanation panel for chart calculations */}
//                 {/* <Box
//                   sx={{
//                     mt:1.2,
//                     background:'#f5f6f7',
...
//                     There are two different calculations here: the <Typography component="span" sx={{ fontWeight:700 }}>average match points</Typography> and the <Typography component="span" sx={{ fontWeight:700 }}>cumulative XP points</Typography>.
//                   </Typography>
//                   <Typography component="p" sx={{ m:0, mt:.6, fontSize:12.5, color:'#333' }}>
//                     The horizontal axis starts with weeks (e.g. 05-Jan) and automatically switches to months once there are enough data points (
//                     <Typography component="span" sx={{ fontWeight:700 }}>{AUTO_SWITCH_THRESHOLD}</Typography>) — current data points: <Typography component="span" sx={{ fontWeight:700 }}>{performanceData.length}</Typography>.
//                   </Typography>
//                   <Typography component="p" sx={{ m:0, mt:.6, fontSize:12.5, color:'#333' }}>
//                     To calculate the average match points, we take the total points in each period (weekly or monthly) divided by the number of matches in that period.
//                   </Typography>
//                   <Typography component="p" sx={{ m:0, mt:.6, fontSize:12.5, color:'#333' }}>
//                     The <Typography component="span" sx={{ fontWeight:700 }}>cumulative XP points</Typography> are built by adding each period's total points to a running sum over time.
//                   </Typography>
//                 </Box> */}
//               </Grid>
//               {/* Win/Loss + Radar (unchanged below) */}
//               <Grid item xs={12} lg={4} container spacing={2}>
//                 {/* Influence (Radar) - left like screenshot */}
...
//                   >
//                     <Box sx={{ px:2, pt:1.2 }}>
//                       <Typography sx={{ fontSize:14, fontWeight:600, color:'#2f2f2f' }}>Influence</Typography>
//                     </Box>
//                     <Box sx={{ flex:1, px:1.5, pb:1 }}>
//                       <ResponsiveContainer width="100%" height="100%">
//                         <RadarChart data={influence} outerRadius={70}>
...
//                             reversed={false}
//                           />
//                           <PolarRadiusAxis stroke="#e5e7eb" tick={{ fill:'#888', fontSize:8 }} tickCount={4} />
//                           <Radar name="Player" dataKey="value" stroke="#0a4a75" fill="#0a4a75" fillOpacity={0.35} />
//                           <Radar name="League Avg" dataKey="scaled" stroke="#06b284" fill="#06b284" fillOpacity={0.18} />
...
//                   </GlassCard>
//                 </Grid>
//                 {/* Win / Loss Donut - right like screenshot */}
//                 <Grid item xs={12} md={6} lg={12}>
//                   <GlassCard
//                     sx={{
//                       p:0,
...
//                   >
//                     <Box sx={{ px:2, pt:1.2 }}>
//                       <Typography sx={{ fontSize:14, fontWeight:600, color:'#2f2f2f' }}>Win/Loss</Typography>
//                     </Box>
//                     <Box sx={{ flex:1, px:1.5, pb:1 }}>
//                       <ResponsiveContainer width="100%" height="100%">
//                         <PieChart>
...
//                           {
//                             (() => {
//                               const total = wld.W + wld.L + wld.D || 1;
//                               const dataPie = [
//                                 { name: 'Win', value: wld.W, color: '#01c7a3' },
//                                 { name: 'Lost', value: wld.L, color: '#0a4a75' },
//                                 { name: 'Draw', value: wld.D, color: '#222222' },
//                               ];
...
//                         <Box sx={{ width:10, height:10, borderRadius:'50%', background:'#01c7a3' }} />
//                         <Typography sx={{ fontSize:11, color:'#444' }}>Win</Typography>
//                       </Box>
//                       <Box sx={{ display:'flex', alignItems:'center', gap:.5 }}>
//                         <Box sx={{ width:10, height:10, borderRadius:'50%', background:'#0a4a75' }} />
//                         <Typography sx={{ fontSize:11, color:'#444' }}>Lost</Typography>
//                       </Box>
//                       <Box sx={{ display:'flex', alignItems:'center', gap:.5 }}>
//                         <Box sx={{ width:10, height:10, borderRadius:'50%', background:'#222' }} />
//                         <Typography sx={{ fontSize:11, color:'#444' }}>Draw</Typography>
//                       </Box>
//                     </Box>
//                   </GlassCard>
//                 </Grid>
//               </Grid>
//               {/* Charts general explanation */}
//               <Grid item xs={12}>
//                 <Box
//                   sx={{
//                     mt:1,
...
//                   }}
//                 >
//                   <Typography component="p" sx={{ m:0, fontSize:12.3 }}>
//                     Please see the larger image of the graph below. These charts should be self-explanatory, displaying players' performance. Player using the app can also select another player they share a league with and can access their stats.
//                   </Typography>
//                 </Box>
//               </Grid>
//             </Grid>
