...
function PrivacyPloices() {
  ...
  return (
    ...
    <div className="flex flex-col gap-5">
      <p>
        <strong>Last updated August 22, 2022</strong>
      </p>
      <p>
        <strong>Purpose of this Privacy Policy</strong>
      </p>
      <p>
        This privacy notice for Champion Footballer, describes how and why we might collect, store, use, and/or share{" "}
        {'("process")'} your information when you use our services {'("Services")'} through your use of this website
        and any mobile application {'("Platform")'}.
      </p>
      <p>
        ...
        you still have any questions or concerns, please contact us at championfootballer@outlook.com
      </p>
      <p>
        Champion Footballer respects your privacy and is dedicated to protecting your personal data. This privacy
        notice will inform you as to how we look after your personal data when you visit our Platform (regardless of
      ...
      <p>
        ...
        to relevant laws including, but not limited to, the General Data Protection Regulation, which applies across
        the European Union (including in the United Kingdom) and we are responsible as {"'controller'"} of that
        personal information for the purposes of those laws.
      </p>
      <p>
        It is important that you read this privacy policy carefully together with any other privacy policy or fair
      ...
      <p>
        ...
        topics below or by using our table of contents below to find the section you are looking for.
      </p>
      <p>
        <strong>What personal information do we process?</strong>When you visit, use, or navigate our Services, we may
        process personal information depending on how you interact with Champion Footballer and the Services, the
        choices you make, and the products and features you use.
      </p>
      <p>
        <strong>Do we process any sensitive personal information?</strong> We process the following sensitive personal
        information; User first name, surname, age, gender and email. Any further change to processing sensitive
        personal information we will inform you about that practice in a revised version of this privacy notice.
      </p>
      <p>We keep our privacy policy under regular review. This version was last updated in August 2022.</p>
      <p>
      ...
      <p>
        ...
        contact form or by contacting us. We will consider and act upon any request in accordance with applicable data
        protection laws.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          and other technology on the devices you use to access this Platform.
        </li>
        <li>
          <strong>Profile Data</strong> includes your username and password made by you, your interests, preferences,
          feedback and survey responses.
        </li>
        <li>
          <strong>Usage Data</strong> includes information about how you use our Platform, products and services.
        </li>
        <li>
      ...
      <p>
        We may also collect, use and share <strong>Aggregated Data</strong> such as statistical data for any purpose.
      ...
      <ul>
        <li>
          ...
          those affiliates to honour this privacy notice. Affiliates include our parent company and any subsidiaries,
      ...
      <p>
        ...
        <em>
          We do not currently have a feature for you to register or log in to our services using a social media
          account, we may include this as an option in the future and when we do we will have access to certain
      ...
      <p>
        ...
        <a
          href="https://app.termly.io/dashboard/website/c8e034fd-09ff-45d5-965a-51ae59d0d2c4/privacy-policy#whoshare"
      ...
      <p>
        ...
        <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" className="text-blue-600 hover:underline">
      ...
      <p>
        ...
        <a
          href="https://app.termly.io/dashboard/website/c8e034fd-09ff-45d5-965a-51ae59d0d2c4/privacy-policy#contact"
          className="text-blue-600 hover:underline"
        >
      ...
      <p>
        ...
        <strong>championfootballer@outlook.com</strong> or by post to:
      </p>
      <div>
        <p>First Floor</p>
        <p>85 Great Portland St,</p>
        <p>London, England,</p>
        <p>W1W 7LL</p>
      </div>
      <ol start={14}>
      ...
      <p>
        ...
        delete your personal information, please submit a request by using the contact form on the website:
        championfootballer.com
      </p>
      <div className="text-3xl font-semibold">Cookie Policy</div>
      <p>
        <strong>Last updated August 22, 2022</strong>
      </p>
      <p>
        This Cookie Policy explains how Champion Footballer uses cookies and similar technologies to recognize you
      ...
      <p>
        ...
        are described below (please note that the specific cookies served may vary depending on the specific Online
      ...
      <p>
       {` Cookies are not the only way to recognize or track visitors to a website. We may use other, similar
        ...
        of users from one page within a website to another, to deliver or communicate with cookies, to understand
     ...
     {`   Websites may also use so-called "Flash Cookies" (also known as Local Shared Objects or "LSOs") to, among other
      ...
      <p>
        ...
        championfootballer@outlook.com or by post to:
      </p>
      <div>
        <p>Champion Footballer</p>
        <p>First Floor</p>
        <p>85 Great Portland St,</p>
        <p>London, England,</p>
        <p>W1W 7LL</p>
